...
from tracker.strongsort.reid_multibackend import ReIDDetectMultiBackend
from tracker.strongsort.sort.detection import Detection
from tracker.strongsort.sort.nn_matching import NearestNeighborDistanceMetric
from tracker.strongsort.sort.tracker import Tracker
...
class StrongSORT(object):
    def __init__(
        ...
        self.tracker = Tracker(metric, max_iou_distance=max_iou_dist, max_age=max_age, n_init=n_init)
